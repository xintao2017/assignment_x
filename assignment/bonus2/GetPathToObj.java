package assignment.bonus2;

/**
 * The main class for Bonus #2, also the main logic to get path.
 *
 *
...
public class GetPathToObj {
    private final static String BONUS_CONFIG_FILE_PATH = "./config_file/assignment_bonus2_config.txt";
